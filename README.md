...
> ⚠️ **Warning:** เมื่อแก้ไขไฟล์ CSV บน GitHub แล้วรัน script ทันที อาจได้ค่าเก่าเนื่องจาก **GitHub CDN Cache** ใช้เวลาประมาณ **3-5 นาที** กว่าจะอัปเดต หากรันแล้วยังเห็นค่าเดิม ให้รอ 3-5 นาทีแล้วรันอีกครั้ง
